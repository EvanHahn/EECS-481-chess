...
public class Consts {
	//The names of Parse Game object properties
	public static final String GAME_OBJECT = "Games";
	
	public static final String P1_FIELD = "player1Name";
	
	public static final String P2_FIELD = "player2Name";
